...
const scalarConfig = {
    ...
    // Set to 'custom' to use your own CSS solely, or use pre-built ones like 'purple', 'moon', 'solarized', etc.
    theme: "moon",
    // Show standard layout or alternate styles
    layout: "modern",
    // Inject custom CSS to override Scalar's CSS variables
    // customCss: `
    //   /*
    //   :root {
...
app.get("/", apiReference(scalarConfig));
app.listen(port, () => {
